...
function custom_copy_script()
{
    wp_enqueue_script('copy-button-script', get_stylesheet_directory_uri() . '/assets/js/copy-button.js', array(), null, true);
}
add_action('wp_enqueue_scripts', 'custom_copy_script');
