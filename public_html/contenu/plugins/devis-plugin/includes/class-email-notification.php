...
class Amid_Email_Notification
{
    ...
    public static function send_admin_notification($quote_data)
    {
        $to = 'amidvoyages@yahoo.fr';
        $subject = 'Nouvelle demande de devis';
        $message = self::get_admin_email_template($quote_data);
    ...
    public static function send_client_confirmation($quote_data)
    {
        $to = $quote_data['email'];
        $subject = 'Confirmation de votre demande de devis';
        $message = self::get_client_email_template($quote_data);
